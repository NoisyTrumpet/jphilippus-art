        ...
        <Grid>
          <Box mb={8} bg={`gray.100`}>
            <Box maxW={`90%`} m={`auto`} py={8}>
              <Heading as="h1" size="xl" mb="2" lineHeight="base" color={themeBlue}>
                Blog
              </Heading>
          ...
          <Grid templateColumns={[`repeat(1, 1fr)`, `repeat(2, 1fr)`, `repeat(2, 1fr)`, `repeat(3, 1fr)`]} gridGap={8} maxW={`90%`} m={`auto`}>
